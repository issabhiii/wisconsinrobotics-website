...
const CursorGrid = ({
  ...
  useEffect(() => {
    ...
    // NOTE (integration): this grid is a *background* layer, so page content
    // sits on top of it. We listen on `window` (instead of the container) so
    // the grid still reacts to the cursor moving over the hero/header, and we
    // ignore events that land outside the canvas bounds.
